...
function Banner() {
  return (
    <>
    <div className='max-w-2x1 container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
    ...
    <div className = "w-full md :w-1/2 mt-12 md:mt-33">
        <div className="space-y-8">
            ...
            Chowdhury Cookaries appears to be a culinary venture, likely offering a diverse range of authentic and freshly prepared dishes or baked goods.
              With a focus on quality ingredients and traditional recipes, they aim to provide customers with a memorable and delightful culinary experience.
              </p>
            ...
            <button className="btn mt-3 btn-secondary">Start Your Buying</button>
             </div>
    </div>
    </>
  )
